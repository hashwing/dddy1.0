...
$sid=$_SESSION['sid'];
include('../inc.php');
$sql="select * from dy_dd where sid='$sid' and zf='1'and dy='3'";
...
?>
  <tr>
    <td bgcolor="#E0EEE0" height="25px"><div align="center">
      <?php echo $row['ddh']; $ddh=$row['ddh']; $zfdd=$row['zfdd']?>
    </div></td>
    <td bgcolor="#E0EEE0" height="25px"><div align="center">
      <?php echo $row['price']?>
    </div></td>
...
<?php 
	...
	$sqls="select * from dy_zfdd where sid='$sid' and zf='2' and zs='0'";
