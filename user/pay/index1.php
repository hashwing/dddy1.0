            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input size="30" name="WIDout_trade_no" value="11111111111" />
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDreceive_name" value="111"/>
                        <span>如：张三</span>
                    </dd>
                    <dt>收货人地址：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDreceive_address" value="111" />
                        <span>如：XX省XXX市XXX区XXX路XXX小区XXX栋XXX单元XXX号</span>
                    </dd>
                    <dt>收货人邮编：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDreceive_zip" value="11111111111" />
                        <span>如：123456</span>
                    </dd>
                    <dt>收货人电话号码：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDreceive_phone"  value="11111111111"/>
                        <span>如：0571-88158090</span>
                    </dd>
                    <dt>收货人手机号码：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDreceive_mobile"  value="11111111111"/>
