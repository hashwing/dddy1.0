...
/**************************请求参数**************************/
        ...
        //必填，不能修改
        //服务器异步通知页面路径
        $notify_url = "http://dy.ggproject.cn/user/pay/notify_url.php";
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径
        $return_url = "http://dy.ggproject.cn/user/pay/return_url.php";
        ...
        //物流费用
        $logistics_fee =$_POST['yunfee'];
        //if($pric<0.5)
        //$logistics_fee = 0.50-$price;
        //必填，即运费
        //物流类型
